    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Aspectos fundamentales en el aprendizaje
        p.mb-4 Validar el conocimiento adquirido sobre la Técnicas y metodologías, cognición, el aprendizaje y la educación.
